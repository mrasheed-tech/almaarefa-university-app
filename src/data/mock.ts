...
export const mail: MailMessage[] = [
  { id: 'm1', fromEn: 'Registration Deanship', fromAr: 'عمادة القبول والتسجيل', subjectEn: 'Course registration opens Sunday', subjectAr: 'فتح التسجيل يوم الأحد', previewEn: 'Registration for the next term opens at 9:00 AM…', previewAr: 'يبدأ التسجيل للفصل القادم الساعة ٩ صباحًا…', date: hoursFromNow(-2), unread: true },
  { id: 'm2', fromEn: 'Dr. Khalid Al-Harbi', fromAr: 'د. خالد الحربي', subjectEn: 'Anatomy II — extra office hours', subjectAr: 'التشريح ٢ — ساعات مكتبية إضافية', previewEn: 'I will hold extra office hours before the exam…', previewAr: 'سأعقد ساعات مكتبية إضافية قبل الاختبار…', date: hoursFromNow(-20), unread: true },
  { id: 'm3', fromEn: 'Library', fromAr: 'المكتبة', subjectEn: 'Your loan is due tomorrow', subjectAr: 'موعد إرجاع الكتاب غدًا', previewEn: 'Reminder: "Gray\'s Anatomy" is due tomorrow…', previewAr: 'تذكير: كتاب "تشريح جراي" يُرجع غدًا…', date: inDays(-1, 8, 0), unread: false },
  { id: 'm4', fromEn: 'Student Affairs', fromAr: 'شؤون الطلاب', subjectEn: 'Volunteering opportunity', subjectAr: 'فرصة تطوعية', previewEn: 'Join the campus health awareness week…', previewAr: 'انضم إلى أسبوع التوعية الصحية…', date: inDays(-2, 12, 0), unread: false },
];
